...
$q1 = mysqli_query($conn, "SELECT * FROM coin_details WHERE coin_order_id='$name';");
...
$query = "SELECT * FROM coin_details WHERE coin_order_id='$name' LIMIT ".$i.",".$rowsperpage.";";
...
while ($row = mysqli_fetch_array($run)) {
	echo '
			...
			<div class="card mb-3">
			  ...
			  <div class="card-body">
			  	<a href="user-view.php?view='.$row['coin_id'].'" class="card-link btn btn-outline-info">View</a>
			  	<a href="user-update.php?update='.$row['coin_id'].'" class="card-link btn btn-outline-primary">Update</a>

...
<div class="container-fluid mb-3">
	<div class="row justify-content-center">
		<div class="col-md-6">	
			...
			<form method="post" action="includes/user-update.inc.php" enctype="multipart/form-data" class="mt-3">
				...
				<a href="user-coins.php" class="card-link btn btn-outline-secondary"><i class="fa fa-arrow-left"></i> BACK</a>

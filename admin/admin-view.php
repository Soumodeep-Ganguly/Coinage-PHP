		...
		<div class="col-md-8">	
			<div class="card mb-3">
			  <h3 class="card-header"><b>Title:</b> <?=  $row['coin_name']; ?></h3>
			    <div class="row">
			  	<div class="col-md-6">			  		
			  		<img style="height: 300px; width: 100%; display: block;" src="gallery/<?=  $row['heads']; ?>" alt="Card image">
			 	</div>
			 	<div class="col-md-6">			  		
			  		<img style="height: 300px; width: 100%; display: block;" src="gallery/<?=  $row['tails']; ?>" alt="Card image">
			 	</div>
			  </div>			  
			  <ul class="list-group list-group-flush">
			    <li class="list-group-item"><b>Currency Type:</b> <?=  $row['currency_type']; ?></li>
			    <li class="list-group-item"><b>Coin Country:</b> <?=  $row['coin_country']; ?></li>
